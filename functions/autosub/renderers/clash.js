/* renderers/clash.js
 * 职责：
 *   - Node[] → Clash / Mihomo / Stash 可用的订阅
 *   - 只输出 proxies 列表，不包含端口、规则、proxy-groups 等配置
 *   - 适合导入到 Stash / Clash 作为“节点订阅”
 */
...
/* Node[] → 只含 proxies 的 YAML（适用于 Clash / Mihomo / Stash 节点订阅） */
